    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 mr-4">
                    <!-- Logo Icon -->
                    <div class="w-9 h-9 bg-blue-600 text-white rounded-xl flex items-center justify-center text-2xl shadow-md flex-shrink-0">
                        <i class="fa-solid fa-s fa-bounce"></i>
                    </div>

                    <!-- Area Tulisan Berjalan -->
                    <div class="overflow-hidden w-72"> <!-- ← Ubah angka ini untuk mengatur lebar area -->
                        <span class="inline-block animate-marquee font-bold text-2xl tracking-tighter dark:text-white">
                            Stockify
                        </span>
                    </div>
                </a>
