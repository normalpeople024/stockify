{{-- resources/views/manager/reports/transactions.blade.php --}}
@extends('layouts.app1')
@section('title', 'Laporan Transaksi')
@section('page-title', 'Laporan Transaksi')
@section('breadcrumb', 'Manajer Gudang / Laporan / Transaksi')
...
<div class="space-y-5">
    ...
    <div class="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-5 hover:shadow-sm transition">
            <div class="w-10 h-10 rounded-xl bg-red-50 text-red-500 flex items-center justify-center mb-3">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24"><path d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
            </div>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-50">
            ...
            <div class="flex gap-2">
                <a href="{{ route('manager.stock.create-in') }}"
                   class="flex items-center gap-1.5 h-8 px-3 text-xs font-semibold text-white rounded-xl transition"
                   style="background:#1D9E75"
                   onmouseover="this.style.background='#0F6E56'"
                   onmouseout="this.style.background='#1D9E75'">
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24"><path d="M5 10l7-7m0 0l7 7m-7-7v18" stroke="white" stroke-width="1.5" stroke-linecap="round"/></svg>
                    Catat Masuk
                </a>
                <a href="{{ route('manager.stock.create-out') }}"
                   class="flex items-center gap-1.5 h-8 px-3 text-xs font-semibold text-red-600 border border-red-200 rounded-xl hover:bg-red-50 transition">
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24"><path d="M19 14l-7 7m0 0l-7-7m7 7V3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
                    Catat Keluar
                </a>
            </div>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-5 py-3.5 text-right text-gray-500">{{ number_format($trx->stock_before) }}</td>
                    <td class="px-5 py-3.5 text-right text-gray-500">{{ number_format($trx->stock_after) }}</td>
                    <td class="px-5 py-3.5 text-center">
                ...
                <tr>
                    <td colspan="11" class="px-6 py-14 text-center">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Coba ubah filter atau catat transaksi baru</p>
                    </td>
                </tr>
                @endforelse
                </tbody>
