{{-- resources/views/manager/products/create.blade.php --}}
@extends('layouts.app1')
@section('title', 'Tambah Produk')
@section('page-title', 'Tambah Produk')
@section('breadcrumb', 'Manajer Gudang / Produk / Tambah')
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-5">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Ukuran, warna, berat, dll.</p>
                </div>
                <button type="button" onclick="addAttr()"
                    ...
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 16 16"><path d="M8 3v10M3 8h10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
                    Tambah
                </button>
            </div>
            <div id="attr-list" class="space-y-3"></div>
            <p id="attr-empty" class="text-xs text-gray-400 text-center py-4">
                Belum ada atribut. Klik "+ Tambah" untuk menambahkan.
            </p>
        </div>
    </div>
    ...
    <div class="space-y-5">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
            <button type="submit"
                class="w-full h-10 text-sm font-semibold text-white rounded-xl transition"
